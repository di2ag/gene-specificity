...
{%- set license_classifiers = { # type: ignore
...
def get_version(*file_paths): # type: ignore
    """Retrieves the version from {{ cookiecutter.app_name }}/__init__.py"""
    filename = os.path.join(os.path.dirname(__file__), *file_paths) # type: ignore
...
{%- if cookiecutter.open_source_license in license_classifiers %} # type: ignore
