...
import {{ cookiecutter.app_name }} # type: ignore
...
copyright = u'{% now 'local', '%Y' %}, {{ cookiecutter.full_name }}' # type: ignore
...
version = {{ cookiecutter.app_name }}.__version__ # type: ignore
# The full version, including alpha/beta/rc tags.
release = {{ cookiecutter.app_name }}.__version__ # type: ignore
